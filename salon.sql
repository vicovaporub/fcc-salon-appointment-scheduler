...
INSERT INTO public.services VALUES (2, 'Hands');
INSERT INTO public.services VALUES (3, 'Feet');
...
--
-- Name: appointments fkser; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkser FOREIGN KEY (service_id) REFERENCES public.services(service_id);
